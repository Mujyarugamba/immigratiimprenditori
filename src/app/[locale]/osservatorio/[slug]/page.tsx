  ...
  return (
    <main id="contenuto" className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <section className="mt-8 grid gap-8 lg:grid-cols-2">
        <div><h2 className="text-xl font-semibold text-black">{l.purpose}</h2><p className="mt-3 text-sm leading-7 text-neutral-700">{indicator.purpose_text}</p></div>
        <div><h2 className="text-xl font-semibold text-black">{l.method}</h2><p className="mt-3 text-sm leading-7 text-neutral-700">{indicator.methodology_summary}</p></div>
      </section>
