...
const labels = {
  ...
  zh: { type: "投稿类型", story: "创业故事", research: "研究贡献", publication: "出版物", event: "活动", interview: "访谈", other: "其他材料", title: "标题或主题", proposal: "投稿内容", name: "姓名", email: "电子邮件", organization: "机构 / 企业", link: "来源、视频或参考链接", contact: "我同意编辑团队就此投稿与我联系。", publicationConsent: "我同意在编辑审核后可能发布所提交的材料。", send: "提交给编辑团队" },
} as const;
...
export async function generateMetadata({ params }: Pick<Props, "params">): Promise<Metadata> {
  ...
  return { title: m.participateTitle, description: m.participateIntro, alternates: { canonical: `/${locale}/contribuisci` } };
}
...
export default async function LocalizedParticipatePage({ params, searchParams }: Props) {
  ...
  return (
    <main id="contenuto" className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      {sent ? (
        <div className="mt-8 border border-black p-6" role="status">✓</div>
      ) : (
