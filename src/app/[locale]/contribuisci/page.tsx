...
const labels = {
  en: { type: "Type of proposal", story: "Entrepreneurial story", research: "Research contribution", publication: "Publication", event: "Event", interview: "Interview", other: "Other material", title: "Title or subject", proposal: "Proposal", name: "Full name", email: "Email", organization: "Organization / company", link: "Source, video or reference link", contact: "I authorize the editorial team to contact me about this proposal.", publicationConsent: "I authorize possible publication of the submitted material, subject to editorial review.", send: "Send to the editorial team", success: "Thank you. Your proposal has been delivered to the private editorial inbox and will be reviewed before any publication.", fieldsError: "Please check the required fields and the information entered.", sendError: "The proposal could not be delivered. Please try again or contact the editorial team." },
  fr: { type: "Type de proposition", story: "Histoire d'entreprise", research: "Contribution de recherche", publication: "Publication", event: "Événement", interview: "Entretien", other: "Autre matériel", title: "Titre ou objet", proposal: "Proposition", name: "Nom et prénom", email: "E-mail", organization: "Organisation / entreprise", link: "Lien source, vidéo ou référence", contact: "J'autorise la rédaction à me contacter au sujet de cette proposition.", publicationConsent: "J'autorise une éventuelle publication du matériel envoyé, sous réserve de la révision éditoriale.", send: "Envoyer à la rédaction", success: "Merci. Votre proposition a été transmise à l'Inbox éditoriale privée et sera examinée avant toute publication.", fieldsError: "Vérifiez les champs obligatoires et les informations saisies.", sendError: "La proposition n'a pas pu être transmise. Réessayez ou contactez la rédaction." },
  es: { type: "Tipo de propuesta", story: "Historia empresarial", research: "Contribución de investigación", publication: "Publicación", event: "Evento", interview: "Entrevista", other: "Otro material", title: "Título o asunto", proposal: "Propuesta", name: "Nombre y apellidos", email: "Correo electrónico", organization: "Organización / empresa", link: "Enlace de fuente, vídeo o referencia", contact: "Autorizo a la redacción a contactarme sobre esta propuesta.", publicationConsent: "Autorizo la posible publicación del material enviado, sujeta a revisión editorial.", send: "Enviar a la redacción", success: "Gracias. Tu propuesta ha sido enviada a la bandeja editorial privada y será revisada antes de cualquier publicación.", fieldsError: "Revisa los campos obligatorios y la información introducida.", sendError: "No se ha podido enviar la propuesta. Inténtalo de nuevo o contacta con la redacción." },
  de: { type: "Art des Vorschlags", story: "Unternehmensgeschichte", research: "Forschungsbeitrag", publication: "Publikation", event: "Veranstaltung", interview: "Interview", other: "Anderes Material", title: "Titel oder Betreff", proposal: "Vorschlag", name: "Vor- und Nachname", email: "E-Mail", organization: "Organisation / Unternehmen", link: "Quellen-, Video- oder Referenzlink", contact: "Ich ermächtige die Redaktion, mich zu diesem Vorschlag zu kontaktieren.", publicationConsent: "Ich ermächtige eine mögliche Veröffentlichung des eingesandten Materials nach redaktioneller Prüfung.", send: "An die Redaktion senden", success: "Vielen Dank. Ihr Vorschlag wurde an die private redaktionelle Inbox übermittelt und wird vor einer Veröffentlichung geprüft.", fieldsError: "Bitte prüfen Sie die Pflichtfelder und die eingegebenen Angaben.", sendError: "Der Vorschlag konnte nicht übermittelt werden. Bitte versuchen Sie es erneut oder kontaktieren Sie die Redaktion." },
  ar: { type: "نوع المقترح", story: "قصة مشروع أو شركة", research: "مساهمة بحثية", publication: "منشور", event: "فعالية", interview: "مقابلة", other: "مواد أخرى", title: "العنوان أو الموضوع", proposal: "المقترح", name: "الاسم الكامل", email: "البريد الإلكتروني", organization: "المؤسسة / الشركة", link: "رابط المصدر أو الفيديو أو المرجع", contact: "أوافق على أن تتواصل معي هيئة التحرير بشأن هذا المقترح.", publicationConsent: "أوافق على إمكانية نشر المواد المرسلة بعد المراجعة التحريرية.", send: "إرسال إلى هيئة التحرير", success: "شكراً لك. أُرسل مقترحك إلى صندوق التحرير الخاص وسيُراجع قبل أي نشر.", fieldsError: "يرجى التحقق من الحقول المطلوبة والمعلومات المدخلة.", sendError: "تعذر إرسال المقترح. يرجى المحاولة مرة أخرى أو التواصل مع هيئة التحرير." },
  zh: { type: "投稿类型", story: "创业故事", research: "研究贡献", publication: "出版物", event: "活动", interview: "访谈", other: "其他材料", title: "标题或主题", proposal: "投稿内容", name: "姓名", email: "电子邮件", organization: "机构 / 企业", link: "来源、视频或参考链接", contact: "我同意编辑团队就此投稿与我联系。", publicationConsent: "我同意在编辑审核后可能发布所提交的材料。", send: "提交给编辑团队", success: "谢谢。您的投稿已送达非公开编辑收件箱，并将在任何发布之前接受审核。", fieldsError: "请检查必填字段和所输入的信息。", sendError: "投稿未能送达。请重试或联系编辑团队。" },
} as const;
      ...
      {sent ? (
        ...
        <form action={submitEditorialContributionAction} className="mt-10 space-y-7">
          ...
          <div className="space-y-4 border-t border-black pt-6 text-sm leading-6 text-neutral-700">
            <label className="flex items-start gap-3"><input name="consent_contact" type="checkbox" required className="mt-1 size-4" /><span>{l.contact}</span></label>
