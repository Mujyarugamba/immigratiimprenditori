        ...
        <section className="preview-support-section">
          ...
          <div className="preview-support-grid">
            ...
            <article>
              ...
              <p>Per sostenere il Centro Studi tramite bonifico, contatta il Centro Studi.</p>
              <a href={`mailto:${SUPPORT_CONFIGURATION.partnershipEmail}`}>Contatta il Centro Studi →</a>
            </article>
          </div>
