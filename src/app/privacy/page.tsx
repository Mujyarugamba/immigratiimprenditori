...
export default async function PrivacyPage({ searchParams }: PageProps) {
  ...
  const accountMessage =
    query.account === "deleted"
      ? "Il tuo account di accesso è stato eliminato. Eventuali dati o materiali editoriali restano soggetti alle finalità e ai tempi di conservazione descritti in questa informativa."
      : query.account === "cleanup"
        ? "L'account applicativo è stato chiuso e i relativi ruoli sono stati revocati, ma la cancellazione tecnica dell'utente di autenticazione deve essere completata. Scrivi a info@immigratiimprenditori.it indicando l'email usata per l'accesso."
        : null;
  ...
  return (
    <main id="contenuto" className="pb-16">
      <Container>
        ...
        {accountMessage ? <p className="mt-6 border border-black px-4 py-3 text-sm leading-6" role="status">{accountMessage}</p> : null}
        ...
        <div className="divide-y divide-black">
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-3 text-sm leading-7 text-neutral-700">
              ...
              <p>Contatto per privacy e diritti degli interessati: <a href={`mailto:${privacyEmail}`} className="font-semibold text-black underline underline-offset-4">{privacyEmail}</a>.</p>
            </div>
          </section>
          ...
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-5 text-sm leading-7 text-neutral-700">
              <div><h3 className="font-semibold text-black">Navigazione e sicurezza</h3><p className="mt-1">Dati tecnici necessari al funzionamento e alla sicurezza del servizio, come indirizzo IP, richieste HTTP, informazioni sul dispositivo/browser e log tecnici quando prodotti dall&apos;infrastruttura.</p></div>
              <div><h3 className="font-semibold text-black">Account e autenticazione</h3><p className="mt-1">Identificativo dell&apos;utente di autenticazione, email usata per l&apos;accesso, stato dell&apos;account e, quando necessario, collegamento al profilo della persona e ai ruoli applicativi.</p></div>
              <div><h3 className="font-semibold text-black">Contribuisci</h3><p className="mt-1">Tipo, titolo e testo della proposta; eventuale URL originale; Paesi di origine/destinazione indicati; nome e cognome, email, telefono facoltativo, organizzazione/impresa; consenso al contatto e consenso facoltativo alla possibile pubblicazione.</p></div>
              <div><h3 className="font-semibold text-black">Interviste e attività redazionale</h3><p className="mt-1">Stato del contatto/intervista, date operative, stato delle autorizzazioni relative a pubblicazione, citazioni, immagini e video, oltre a note interne limitate a quanto necessario per il lavoro editoriale.</p></div>
              <div><h3 className="font-semibold text-black">Fonti pubbliche</h3><p className="mt-1">La redazione può registrare dati professionali già resi pubblici per verificare un soggetto, una fonte o un possibile protagonista editoriale. Questi dati servono alla ricerca e alla verifica e non determinano pubblicazione automatica.</p></div>
          ...
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-5 text-sm leading-7 text-neutral-700">
              ...
              <p><strong className="text-black">Pubblicazione di materiali inviati, interviste, citazioni, immagini o video:</strong> consenso/autorizzazione dell&apos;interessato quando richiesta. Le autorizzazioni sono gestite separatamente.</p>
              <p><strong className="text-black">Ricerca editoriale su fonti pubbliche:</strong> legittimo interesse di AIPEL a svolgere attività di ricerca, verifica e documentazione coerenti con la finalità dell&apos;Osservatorio, art. 6, par. 1, lett. f) GDPR.</p>
          ...
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-4 text-sm leading-7 text-neutral-700">
              ...
              <p>Telefono, organizzazione, titolo, link e contesto geografico sono facoltativi. Il consenso alla possibile pubblicazione è facoltativo.</p>
            </div>
          </section>
          ...
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-4 text-sm leading-7 text-neutral-700">
              <p>I dati possono essere trattati da persone autorizzate della redazione e dell&apos;organizzazione e da fornitori tecnici necessari per hosting, database, autenticazione, sicurezza e comunicazioni operative.</p>
          ...
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-4 text-sm leading-7 text-neutral-700">
              ...
              <p><strong className="text-black">Log tecnici direttamente gestiti dal progetto:</strong> non oltre 90 giorni in condizioni ordinarie; un evento di sicurezza può richiedere conservazione ulteriore limitata al tempo necessario.</p>
            </div>
          </section>
          ...
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-4 text-sm leading-7 text-neutral-700">
              ...
              <p>Se hai un account attivo puoi eliminare autonomamente l&apos;accesso e i relativi ruoli dalla pagina <Link href="/app/account" className="font-semibold text-black underline underline-offset-4">Gestisci account</Link>. L&apos;eliminazione dell&apos;account non comporta automaticamente la cancellazione di eventuali profili, articoli, interviste, eventi o altri materiali editoriali, che possono avere finalità e tempi di conservazione diversi.</p>
              <p>Per esercitare i diritti sui dati personali e sui materiali editoriali, o per chiedere una verifica ulteriore dopo l&apos;eliminazione dell&apos;account, scrivi a <a href={`mailto:${privacyEmail}`} className="font-semibold text-black underline underline-offset-4">{privacyEmail}</a>.</p>
          ...
          <section className="grid gap-8 py-10 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="space-y-4 text-sm leading-7 text-neutral-700">
              ...
              <p>Per l&apos;identità dell&apos;ente promotore e la governance editoriale vedi <Link href="/chi-siamo" className="font-semibold text-black underline underline-offset-4">Chi siamo</Link>.</p>
            </div>
          </section>
        </div>
      </Container>
