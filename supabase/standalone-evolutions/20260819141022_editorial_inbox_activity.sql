-- Canonical post-cutover Centro Studi migration captured from the hosted
-- Supabase migration history. This file is used to reproduce the standalone
-- schema locally; it is NOT automatically applied to Production.
