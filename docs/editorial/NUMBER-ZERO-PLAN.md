...
La home deve poter mostrare contemporaneamente:

1. un dato;
2. un'analisi/rapporto;
3. una storia/intervista;
4. un evento o una nuova pubblicazione;
5. invito a contribuire;
6. link evidente a Fonti e metodologia.

## Criterio di prontezza

Il numero zero è pronto quando non richiede testi placeholder per sembrare vivo e quando almeno una persona esterna può capire, dalla sola home, che il progetto:

- misura il fenomeno;
- lo interpreta;
- ascolta persone reali;
- ha copertura internazionale;
- dichiara le fonti;
