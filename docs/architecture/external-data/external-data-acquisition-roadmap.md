...
**Stato:** aggiornato da D1-B.1 (2026-08-13) — Opportunities prepare migration applied **local only**; 20 Incentivi.gov review-only rows in local DB; remote/Production untouched; Eurostat OBS-EU-SELF-CIT Production still live; UC blocked
...
Contratti: **D1.2 COMPLETE**. Pilot D1.3A-1: **Eurostat Production COMPLETE**; Unioncamere still blocked. D1-B Opportunities: **contract + migration prepare COMPLETE** (apply/import STOP). Reports: `d1.3a-observatory-first-ingestion-report.md`, `d1.3a-1b-eurostat-production-ingestion-validation.md`, `d1-b-opportunities-*.md`.
...
**D1-B.1 (2026-08-13):** local apply `20260820100000` + 20 review-only imports — **REMOTE APPLY NO / PRODUCTION WRITE NO / AUTO-PUBLISH NO**. Report: `d1-b1-opportunities-local-ingestion-validation.md`.
...
4. ~~D1-B.1 local apply + review-only import~~ **DONE** → ~~**D1-B.2** remote apply + Production review-only pilot + redazione queue~~ **DONE** (AUTO-PUBLISH=NO; **20 unpublished**; editorial publish of the 20 still requires human GO)
5. D1.5 — Mercati M1 WB (only after D1-B human GO / separate auth)
