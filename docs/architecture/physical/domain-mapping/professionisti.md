...
2. `professional_categories.group_code IN ('legal_tax_labor','finance_credit','technical_built','digital_communication','trade_international','people_org','real_estate','linguistic_intercultural','ip_innovation','residual','cultural_creative')` — `cultural_creative` aggiunto in C3.2 (additivo; i 10 gruppi ciclo 1 restano).
