...
| D9 | Mercati Internazionali | Appartenenze | Necessaria (quando applicabile) | Mercati Internazionali → Appartenenze | Titolo con cui una Persona dichiara per conto di un'Impresa (`membership_id` opzionale su Presenza/Interesse/Relazione/Esigenza, ciclo 1) | Appartenenze | Verifica del titolo di rappresentanza (§6; `domain-mapping/mercati-internazionali.md` §9, §35) | Bypassare la verifica del titolo | Consolidata |
...
|---|---|---|---|---|---|---|
| DV1 | `imprese.md` §2 vs. `reconciliation-report.md` §11.2 | `MercatoImpresa` attribuito a Mercati Internazionali | **Chiusa:** conferma integrale in `domain-mapping/mercati-internazionali.md` (§9, §35) e D6–D9 | Alta | — | Completata |
...
| DV6 | Questa mappa, §6 | Natura Informativo/Relazionale del Mercato | **Chiusa:** Mercato ha vita indipendente (AR governance); Presenza/Interesse sono AR relazionali distinti (`domain-mapping/mercati-internazionali.md` §4, §9, §35) | Alta | — | Completata |
...
| Basso accoppiamento | Positivo, con riserva | Le dipendenze necessarie sono state classificate con severità (§16); le dipendenze "necessarie quando applicabile" verso Appartenenze (D9/D17/D23/D28) restano un accoppiamento trasversale di utilizzo; D9 è Consolidata dal mapping Mercati; D17 e D23 sono confermate dai mapping di Opportunità e Collaborazioni | Medio | Verificare D28 nei mapping ancora aperti; mantenere D9/D17/D23 come utilizzo, non come possesso della relazione |
