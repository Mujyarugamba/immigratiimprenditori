...
grep -Eq 'TABLE .* public .*contents|TABLE DATA .* public .*contents' "$LIST_FILE"
grep -Eq 'TABLE .* public .*observatory_indicators|TABLE DATA .* public .*observatory_indicators' "$LIST_FILE"
